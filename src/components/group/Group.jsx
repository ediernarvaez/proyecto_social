          ...
          <div className="col-span-4 lg:col-span-2 bg-zinc-800/40 rounded-lg">
            <span className="flex flex-col lg:flex-row gap-2 items-start p-4 justify-between">
              <span>
                ...
                <a
                  href="https://www.figma.com/proto/ylATqJesgGS3tlWx5ddmxA/Holandes_herrante?page-id=0%3A1&node-id=1%3A2&viewport=122%2C149%2C0.19&scaling=scale-down&starting-point-node-id=1%3A2"
                  target="_blank"
          ...
          <div className="col-span-4 lg:col-span-2 bg-zinc-800/40 rounded-lg">
            <span className="flex flex-col lg:flex-row gap-2 items-start p-4 justify-between">
              <span>
                ...
                <a
                  href="https://www.figma.com/proto/6KKToiGzXDovk5WTYnbFIh/Untitled?node-id=1%3A2&scaling=contain&page-id=0%3A1"
                  target="_blank"
                  className="text-normal font-normal dark:text-indigo-400 text-blue-800 text-sm hover:underline"
                  rel="noreferrer"
                >
